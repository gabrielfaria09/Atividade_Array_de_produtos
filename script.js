const produtos = [
    ...
    ['Notebook Samsung', '1 TB SSD', '16 GM RAM', 'R$ 5000', 'assets/Imagem3.avif'],
...
function filtrar(){
    ...
    produtos.filter(([nome, armazenamento, memória, preço, imagem]) => 
    nome.toLowerCase().includes(valor) || armazenamento.toLowerCase().includes(valor)
     || memória.toLowerCase().includes(valor))
    .forEach(([nome, armazenamento, memória, preço, imagem]) => {
